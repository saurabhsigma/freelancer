                            ...
                            <Card className="h-full hover:border-slate-400 transition-colors cursor-pointer group">
                                <CardContent className="pt-6">
                                    <div className="flex items-start justify-between">
                                        <div>
                                            <h3 className="font-semibold text-lg text-slate-900 group-hover:text-slate-700">{client.name}</h3>
                                            {client.company && <p className="text-sm text-slate-500 font-medium">{client.company}</p>}
                                        </div>
